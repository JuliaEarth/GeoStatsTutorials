...
It doesn't involve variograms, training images, or any tuning parameter. These concepts belong to solvers. Let's make it a concrete example, and create some data:
"""

# ╔═╡ bd1eb814-e743-45f8-95b5-255702bd146c
𝒮 = let
...
md"""Finally, we define the estimation problem for the z variable:"""

# ╔═╡ c7799332-183c-11eb-2ed2-95ee6c83a881
problem = EstimationProblem(𝒮, 𝒟, :z)
...
contour(sol, clabels=true)

# ╔═╡ 132510c0-183d-11eb-029b-71a0dcb0d2d1
contourf(sol, clabels=true)

# ╔═╡ 19d95fc0-183d-11eb-395c-87b08a38bbde
surface(sol, camera=(50,70))
...
git-tree-sha1 = "2bc7377520e49549395187ef9c86b4de0b722d27"
...
git-tree-sha1 = "004f7d709c828f979ab4e173865fc6af1a297d2f"
...
git-tree-sha1 = "7cbe88c54c0d2853d9da430d85278767db2f5276"
...
git-tree-sha1 = "45fb3f70d410f3c1fea3ed7cf00c65d74ea8f117"
...
git-tree-sha1 = "94e1445f2fd565082a20ea4be2268f80c8cc3ba5"
